...
export const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:saturate-[.6] hover:saturate-[1.25] [&_svg]:pointer-events-none [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				default:
			...
			size: {
				lg: "text-base h-10 rounded-md px-8 [&_svg]:-ml-4 [&_svg]:size-5",
